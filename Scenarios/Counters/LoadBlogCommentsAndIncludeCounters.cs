...
namespace Counters
{
    ...
    {
        public LoadBlogCommentsAndIncludeCounters(string orchestratorUrl, string testName, int round, string testid) : base(orchestratorUrl, testName, "Aviv", round, testid)
        {
        }
